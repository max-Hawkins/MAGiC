...
extern "C" void create_power_spectrum(int8_t *h_complex_block, raw_file_t *raw_file, int block_idx){
    ...
    if(sprintf(save_block_append, "_block%03d_power.dat", block_idx) < 0){
